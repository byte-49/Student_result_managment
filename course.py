    ...
    def delete(self):
        ...
        try:
            if self.var_course.get()=="":
                    messagebox.showerror("Error","Course Name is should be required",parent=self.root)
            else:
    ...
    def add(self):
        ...
        try:
            if self.var_course.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Course Name is All Ready Present!",parent=self.root)
                else:
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row==None:
                    ...
                    cur.execute("""
                        UPDATE course 
                        SET name=?, duration=?, charges=?, description=? 
                        WHERE name=?
                        """,(
                        self.var_course.get(),
                        self.var_duration.get(),
