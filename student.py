...
class StudentClass:
    def __init__(self,root):
        ...
        title=Label(
            ...
            bg="#033054",
            fg="white"
        ).place(x=10,y=15,width=1260,height=35)
       ...
       #----coloumn1----
        ...
        lbl_emails=Label(self.root,text="Emails",font=("goudy old style",15,'bold'),bg='white').place(x=10,y=140) 
        ...
        lbl_addmition=Label(self.root,text="Addmission",font=("goudy old style",15,'bold'),bg='white').place(x=360,y=140) 
        ...
        txt_addmition=Entry(self.root,textvariable=self.var_a_date,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=480,y=140,width=200)  
        ...
        self.txt_address.place(x=150,y=270,width=530,height=100) 
        ...
        self.CourseTable=ttk.Treeview(self.C_Frame,columns=("id","roll","name","email","gender","dob","contact","admission","course","state","city","pin","address"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
