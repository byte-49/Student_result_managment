...
class reportClass:
    def __init__(self,root):
        ...
        self.root.geometry("1280x540+80+170")
        ...
        title=Label(
            ...
            bg="#FFA600",
            fg="#262626"
        ).place(x=10,y=15,width=1260,height=50)
        ...
        btn_clear=Button(self.root,text='Clear',font=("goudy old style",15,"bold"),bg="#9eacb7",fg="white", cursor="hand2", command=self.clear).place(x=800,y=100,width=100,height=35)
        ...
        self.roll.place(x=150,y=285,width=150,height=50)

        self.name = Label(self.root, font=("goudy old style",15,'bold'), bg='white', bd=2, relief=GROOVE)
        self.name.place(x=300,y=285,width=150,height=50)

        self.course = Label(self.root, font=("goudy old style",15,'bold'), bg='white', bd=2, relief=GROOVE)
        self.course.place(x=450,y=285,width=150,height=50)

        self.marks = Label(self.root, font=("goudy old style",15,'bold'), bg='white', bd=2, relief=GROOVE)
        self.marks.place(x=600,y=285,width=150,height=50)

        self.full = Label(self.root, font=("goudy old style",15,'bold'), bg='white', bd=2, relief=GROOVE)
        self.full.place(x=750,y=285,width=150,height=50)

        self.per = Label(self.root, font=("goudy old style",15,'bold'), bg='white', bd=2, relief=GROOVE)
        self.per.place(x=900,y=285,width=150,height=50)


        #---button_delete----
        btn_delete=Button(self.root,text='Delete',font=("goudy old style",15,"bold"),bg="#ff0000",fg="white", cursor="hand2",command=self.delete ).place(x=525,y=370,width=150,height=35)
    ...
    def delete(self):
        ...
        try:
            if self.var_id=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Invalid Sudent result!",parent=self.root)
                else:
